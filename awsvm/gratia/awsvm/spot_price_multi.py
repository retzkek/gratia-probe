...
import os
import time
# ST--10/28/2015 modifying subroutine to support multiple region/account
# there must be a way to pass the already-established Session and 
# Client objects to the subroutine from the main program
# but I don't know what it is at the moment, so making
# a new connection inside the subroutine.
class spot_price:
	def __init__(self,acct,region):
# ST should trap exceptions here
