...
# Version: $Id: dCacheBillingAggregator.py,v 1.2 2008-02-13 22:49:58 greenc Exp $
#
...
class dCacheProbeConfig( Gratia.ProbeConfiguration ):
    ...
    def get_OnlySendInterSiteTransfers( self ):
        return self.getConfigAttribute( 'OnlySendInterSiteTransfers' ) == 'true'
...
if __name__ == '__main__':
    ...
    try:
        ...
        Gratia.RegisterReporterLibrary( "psycopg2", "2.0.5.1" )
        Gratia.RegisterReporterLibrary( "SQLAlchemy", "0.3.8" )
        Gratia.RegisterReporter( "dCacheBillingAggregator", "2.0" )
        Gratia.RegisterService( "dCache", "1.8" )
